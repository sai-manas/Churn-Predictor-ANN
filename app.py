...
# Cache model and resource loading to avoid reloading them on every app run
...
# Load resources
model, label_encoder_gender, onehot_encoder_geo, scaler = load_model_and_resources()
